...
namespace codepad::os {
	...
	dynamic_library::symbol_t dynamic_library::find_symbol_raw(const std::u8string &name) const {
		return GetProcAddress(_handle, reinterpret_cast<const char*>(name.c_str()));
	}
}
