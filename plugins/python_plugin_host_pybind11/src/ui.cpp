...
void register_ui_classes(py::module &m) {
	...
	py::class_<cp::ui::mouse_scroll_info>(m, "mouse_scroll_info")
		.def_readonly("delta", &cp::ui::mouse_scroll_info::delta)
		.def_readonly("position", &cp::ui::mouse_scroll_info::position)
		.def_property_readonly("handled", &cp::ui::mouse_scroll_info::handled)
		.def("mark_handled", &cp::ui::mouse_scroll_info::mark_handled);
	...
	py::class_<cp::ui::mouse_button_info>(m, "mouse_button_info")
		...
		.def_property_readonly("focus_set", &cp::ui::mouse_button_info::focus_set)
