...
namespace codepad::editors::code {
	...
	struct fragment_generation_result {
		...
		/// indicates how many characters before the next fragment will be generated by a component.
		std::size_t steps = 0;

		/// Returns a \ref fragment_generation_result indicating that a component won't generate any more fragments.
